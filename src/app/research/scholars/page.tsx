...
export const metadata: Metadata = { title: 'Research Scholars – GICEAS' }

export default function Page() {
  return (
    <>
      <PageHero title="Research Scholars" subtitle="GICEAS research scholars — faculty guides and research scholars pursuing doctoral and post-doctoral work."
        badge="Research" breadcrumbs={[{ label: 'Research', href: '/research' }, { label: 'Scholars' }]} />
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <div className="card p-8 text-center">
            <GraduationCap size={40} className="text-[#1e3a8a] mx-auto mb-4" />
            <h2 className="font-bold text-gray-900 text-xl mb-3">Research Scholars</h2>
