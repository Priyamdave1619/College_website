...
export const metadata: Metadata = { title: 'Placement – Microbiology', description: 'Placement statistics and recruiter information for Microbiology students at GICEAS.' }
...
export default function PlacementDeptPage() {
  return (
    <>
      <PageHero title="Placement – Microbiology" subtitle="Career outcomes and industry connections for Microbiology graduates from GICEAS."
        badge="Placement Cell" breadcrumbs={[{ label: 'Placement', href: '/placement' }, { label: 'Microbiology' }]} />
