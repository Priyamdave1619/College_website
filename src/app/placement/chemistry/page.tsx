...
export const metadata: Metadata = { title: 'Placement – Chemistry', description: 'Placement statistics and recruiter information for Chemistry students at GICEAS.' }
...
export default function PlacementDeptPage() {
  return (
    <>
      <PageHero title="Placement – Chemistry" subtitle="Career outcomes and industry connections for Chemistry graduates from GICEAS."
        badge="Placement Cell" breadcrumbs={[{ label: 'Placement', href: '/placement' }, { label: 'Chemistry' }]} />
