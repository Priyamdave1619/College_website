...
export const metadata: Metadata = { title: 'Placement – Biotechnology', description: 'Placement statistics and recruiter information for Biotechnology students at GICEAS.' }
...
export default function PlacementDeptPage() {
  return (
    <>
      <PageHero title="Placement – Biotechnology" subtitle="Career outcomes and industry connections for Biotechnology graduates from GICEAS."
        badge="Placement Cell" breadcrumbs={[{ label: 'Placement', href: '/placement' }, { label: 'Biotechnology' }]} />
