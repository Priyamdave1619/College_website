...
export const metadata: Metadata = { title: 'ICC – Plan of Actions', description: 'Annual plan of actions for prevention of sexual harassment at GICEAS.' }

export default function ICCSubPage() {
  return (
    <>
      <PageHero title="Plan of Actions" subtitle="Annual plan of actions for prevention of sexual harassment at GICEAS."
        badge="ICC" breadcrumbs={[{ label: 'ICC', href: '/icc' }, { label: 'Plan of Actions' }]}
        gradient="bg-gradient-to-br from-purple-900 to-[#1e3a8a]" />
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <div className="card p-8">
            <Shield size={32} className="text-purple-500 mb-4" />
            <h2 className="font-bold text-gray-900 text-xl mb-4">Plan of Actions</h2>
            <p className="text-gray-600 text-sm leading-relaxed mb-4">Annual plan of actions for prevention of sexual harassment at GICEAS.</p>
