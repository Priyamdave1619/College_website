...
export const metadata: Metadata = { title: 'ICC – Disciplinary Mechanism', description: 'Disciplinary action and redressal mechanism followed by the GICEAS ICC.' }

export default function ICCSubPage() {
  return (
    <>
      <PageHero title="Disciplinary Mechanism" subtitle="Disciplinary action and redressal mechanism followed by the GICEAS ICC."
        badge="ICC" breadcrumbs={[{ label: 'ICC', href: '/icc' }, { label: 'Disciplinary Mechanism' }]}
        gradient="bg-gradient-to-br from-purple-900 to-[#1e3a8a]" />
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <div className="card p-8">
            <Shield size={32} className="text-purple-500 mb-4" />
            <h2 className="font-bold text-gray-900 text-xl mb-4">Disciplinary Mechanism</h2>
            <p className="text-gray-600 text-sm leading-relaxed mb-4">Disciplinary action and redressal mechanism followed by the GICEAS ICC.</p>
