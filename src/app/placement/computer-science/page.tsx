...
export const metadata: Metadata = { title: 'Placement – Computer Science', description: 'Placement statistics and recruiter information for Computer Science students at GICEAS.' }
...
export default function PlacementDeptPage() {
  return (
    <>
      <PageHero title="Placement – Computer Science" subtitle="Career outcomes and industry connections for Computer Science graduates from GICEAS."
        badge="Placement Cell" breadcrumbs={[{ label: 'Placement', href: '/placement' }, { label: 'Computer Science' }]} />
